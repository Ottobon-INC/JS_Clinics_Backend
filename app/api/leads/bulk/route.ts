    ...
    try {
        ...
        for (const lead of normalizedLeads) {
            ...
            const payload = sanitizePayload({
                ...
                problem: encrypt(toValue(lead.problem)),
                treatment_doctor: encrypt(toValue(lead.treatment_doctor)),
                treatment_suggested: encrypt(toValue(lead.treatment_suggested)),
